...
public class MinimalDraggableExampleActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerViewDragDropManager dragMgr = new RecyclerViewDragDropManager();   // 管理类

        dragMgr.setInitiateOnMove(false);      // Item移动时便执行拖拽
        dragMgr.setInitiateOnLongPress(true);  // 设置长按拖拽

        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setAdapter(dragMgr.createWrappedAdapter(new MyAdapter())); // 在管理类中对adapter进行包装，使其具有可拖拽性
